...
public interface PostRepository
	...
	// 전체 게시물 조회 및 페이징처리
	@Query(value = "select post_num, community_num, member_num, view_cnt, content, post_date, post_type, title, update_date from Post order by post_num desc", nativeQuery=true)
