...
public interface CalendarRepository extends JpaRepository<Calendar, Long> {
	@Transactional
	@Query(value = "SELECT * FROM Calendar c INNER JOIN Member m ON m.member_num = :num AND c.mem_num = m.member_num WHERE :today BETWEEN c.alarm AND c.start_date", nativeQuery = true)
